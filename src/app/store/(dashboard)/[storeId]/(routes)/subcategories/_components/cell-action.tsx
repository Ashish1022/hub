...
import { SubCategoryColumn } from './column'
...
const CellAction = ({ data }: CellActionProps) => {
  ...
  const onCopy = (id: string) => {
    ...
    toast.success("SubCategoryId copied to the clipboard.")
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align='end'>
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem onClick={() => router.push(`/store/${params.storeId}/subcategories/${data.id}`)}>
